...
var cssd = [
    ...
    "/Individual Post/", 
        ...
        "}",
        "div.RR-M-.QN629 > span, div.Jv7Aj.mArmR.pZp3x >div> span,a._2dbep.qNELH.kIKUG{",
...
"}",
        ...
        "}",
  ".MWDvN {",// navigation center after scroll
...
async function themebutton() {
    if(document.URL=="https://www.instagram.com/"){
      if(document.querySelector("#react-root > section > nav > div._8MQSO.Cx7Bp > div > div > div.ctQZg > div > div.theme")==null){
        //await delay(1000);
...
function goodies(){
  ...
  if(localStorage.getItem("nc")!=0){
  if(this.oldScroll < this.scrollY){
    document.querySelector("#react-root > section > nav > div._8MQSO.Cx7Bp > div").style.display="none";
}
if(this.oldScroll > this.scrollY){
    document.querySelector("#react-root > section > nav > div._8MQSO.Cx7Bp > div").style.display="block";
}}
  this.oldScroll = this.scrollY;
}
		/*--------------broken instagram fix -----------*/
	if(document.URL=="https://www.instagram.com/"){if(document.querySelector("#react-root > section > main > div > div > div > div")!=null){if(document.querySelector("#react-root > section > main > div > div > div > div").innerText=="The link you followed may be broken, or the page may have been removed. Go back to Instagram."){
document.querySelector("#react-root > section > nav > div._8MQSO.Cx7Bp > div > div > div.oJZym > a > div > div > img").click();
}}}
  /*--------------new page navigation hide -----------*/

sccr();
  if(localStorage.getItem("nc")==0){
  var time1 = setInterval(function() {console.log('fff');
if(document.querySelector("#react-root > section > nav > div._8MQSO.Cx7Bp > div")!=null){
          document.querySelector("#react-root > section > nav > div._8MQSO.Cx7Bp > div").style.display="none";clearInterval(time1);}
}, 100);}
  function sccr(){
if(document.querySelector("#react-root > section > nav > div._8MQSO.Cx7Bp > div")!=null){
          document.querySelector("#react-root > section > nav > div._8MQSO.Cx7Bp > div").style.display="none";}
  }
  		/*--------------click event after page change  -----------*/
window.addEventListener('click', event => {trk++;//Theme button when tab change 
  console.log(trk);
                                           if(localStorage.getItem("nc")==0){
                                           setTimeout(function(){sccr(); }, 500);
                                           setTimeout(function(){sccr(); }, 1000);
                                           setTimeout(function(){sccr(); }, 2000);
                                           setTimeout(function(){sccr(); }, 3000);}
...
//         });
    ...
    function addMedia(media, container) {
        ...
        for (let m of medias) {
            ...
            a.style.paddingInline='10px';
            if (m.is_video) {
                let vid = document.createElement('video');
                vid.src = m.video_url;
                vid.controls = true;
                vid.volume = VID_VOLUME;
                vid.style.paddingInline='10px';
                a.textContent = 'Link';
...
`;
    ...
    function startUp() {
        let tempDiv = document.createElement('div');
        tempDiv.innerHTML = `<div style="margin: 20px;font-size: 18px;font-weight: bold;color:'+dcolor+'; cursor: pointer;"><h2>++</h2></div>`;
...
/*----------------------------get followed list----------------------*/	
function follow(){if(document.URL=="https://www.instagram.com/accounts/access_tool/accounts_you_follow"||document.URL=="https://www.instagram.com/accounts/access_tool/current_follow_requests"){
...
while(document.querySelector("#react-root > section > main > div > article > main > section > div:nth-child("+i+")")!=null)
{
str=str+"<a target='_blank' rel='noopener noreferrer' href=\"https://www.instagram.com/"+document.querySelector("#react-root > section > main > div > article > main > section > div:nth-child("+i+")").innerText+"/\">"+document.querySelector("#react-root > section > main > div > article > main > section > div:nth-child("+i+")").innerText+"</a><br>";i++;
}
  str=str+"</div>"
...
function insff(){
	var newf=localStorage.getItem("nf");
		if(newf==null){
		localStorage.setItem("nf",0);}
		if(newf==1){
		insf();
		setTimeout(() => {insf();}, 2000);
		setTimeout(() => {insf();}, 4000);}
function insf(){
if(document.querySelector("#react-root > section > main > div > header > section > div.nZSzR > div.Igw0E.IwRSH.eGOV_.ybXk5._4EzTm.bPdm3 > div > div.Igw0E.IwRSH.eGOV_.vwCYk.i0EQd > button")!=null){
window.close();
}
  if(document.querySelector("#react-root > section > main > div > header > section > div.nZSzR > div.Igw0E.IwRSH.eGOV_.ybXk5._4EzTm.bPdm3 > div > div > button")){
if(document.querySelector("#react-root > section > main > div > header > section > div.nZSzR > div.Igw0E.IwRSH.eGOV_.ybXk5._4EzTm.bPdm3 > div > div > button").innerText=="Requested"){
  window.close();
}}
}}
/*var i=1;var str="";follow2link
while(i<=35)
{str="";
str="<a href=\"https://www.instagram.com/"+document.querySelector("#react-root > section > main > div > article > main > section > div:nth-child("+i+")").innerText+"/\">"+document.querySelector("#react-root > section > main > div > article > main > section > div:nth-child("+i+")").innerText+"</a><br>";
document.querySelector("#react-root > section > main > div > article > main > section > div:nth-child("+i+")").innerHTML=str;
i++;
}*/
